...
<head>
  ...
  <meta name="author" content="Romi Nur Aji">
...
<body class="d-flex flex-column h-100">
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-info">
      <a class="navbar-brand" href="#">AplikasiSPP</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/siswa/logout" data-confirm="Anda yakin akan mengakhiri ?"><i class="fas fa-sign-out-alt"></i> Logout</a>
          </li>
